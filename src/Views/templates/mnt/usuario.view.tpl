...
<section>
  <form action="index.php?page=mnt_usuario&mode={{mode}}&usercod={{usercod}}"
    ...
    {{if readonly}}
    <section>
        <label for='userfching'>Fecha de creación</label>
    ...
    <div id="pswd_field" {{ifnot chgpswd}}class="d-none"{{endifnot chgpswd}}>
      ...
      <section>
        <label for='userpswdrpt'>Repetir Contraseña</label>
    ...
    <section>
        <label for='userpswdexp'>Fecha de expiración de contraseña</label>
